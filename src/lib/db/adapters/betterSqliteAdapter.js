...
export async function createBetterSqliteAdapter(filePath) {
  // webpackIgnore: better-sqlite3 is an OPTIONAL native dependency — the build
  // must succeed on machines without it (driver.js falls back to node:sqlite /
  // sql.js at runtime when this import throws).
